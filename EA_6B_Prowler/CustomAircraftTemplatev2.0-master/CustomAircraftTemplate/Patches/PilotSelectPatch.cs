...
namespace CustomAircraftTemplateEA6B
{
    ...
    public class StartPilot
    {
        ...
        {
            //Debug.Log("EA6B StartPilot Patch 1.0");
    ...
    public class LoadInAircraftsWeapons
    {
        ...
        public static void Prefix(LoadoutConfigurator __instance)
        {
            ...
            //Debug.Log("EA6B LIAWPF  1.0");
            //Debug.Log("EA6B LIAWPF  1.2");
            foreach (string item2 in PilotSaveManager.currentVehicle.GetEquipNamesList())
            {
                //Debug.Log("EA6B LIAWPF  1.3" + item2);
                ...
                {
                    //Debug.Log("EA6B LIAWPF  1.4" + item2);
                    __instance.availableEquipStrings.Add(item2);

                }
            }
            //Debug.Log("EA6B LIAWPF  1.5");
    ...
    public class EA6B_FireStartFlyingEvents_post
    {
    ...
    public static class VehicleDelayedFunctions
    {
        ...
        {
            //Debug.Log("EA6B  1.27.1");
            yield return new WaitForSeconds(3f);
            //Debug.Log("EA6B  1.27.2");
            CustomElements.SetUpGauges();
           // Debug.Log("EA6B  1.27.3");
            PilotSelectPatch.SetNVGShader();
            // Debug.Log("EA6B  1.27.4");
            yield break;
        }
    }
...
*/
        public static IEnumerator BetterSetupCampaignScreenRoutine(CampaignSelectorUI instance)
        {
            ...
            //Debug.Log("EA6B BSCSCR Patch 1.2");
            ...
            //Debug.Log("EA6B BSCSCR Patch 1.3");
            if (_campaignsParent)
            {
                //Debug.Log("EA6B BSCSCR Patch 1.4");
            ...
            //Debug.Log("EA6B BSCSCR Patch 1.5");
            ...
            //Debug.Log("EA6B BSCSCR Patch 1.6" + PilotSaveManager.currentVehicle.vehicleName);
            ...
            //Debug.Log("EA6B BSCSCR Patch 1.6.0.1" + _aircraft[0]);

            {
                //Debug.Log("EA6B BSCSCR Patch 1.6.1");
                _aircraft.Add("F/A-26B");


            }
            //Debug.Log("EA6B BSCSCR Patch 1.7");
            foreach (var vName in _aircraft)
            {
                //Debug.Log("EA6B BSCSCR Patch 1.8: " + vName);
                ...
                if (PilotSaveManager.GetVehicle(vName).campaigns != null)
                {
                    foreach (var campaign in PilotSaveManager.GetVehicle(vName).campaigns)
                    {
                        ...
                        else if (campaign.readyToPlay)
                        {
                            ...
                            //Debug.Log("EA6B BSCSCR Patch 1.18");
            ...
            sw.Stop();
            //Debug.Log("EA6B [CSIPatch] Time loading vehicle campaigns: " + sw.ElapsedMilliseconds.ToString());
            sw.Reset();
            sw.Start();
            VTResources.GetCustomCampaigns();
            sw.Stop();
            //Debug.Log("EA6B [CSIPatch] Time loading custom campaigns list: " + sw.ElapsedMilliseconds.ToString());
            sw.Reset();
            sw.Start();
            ...
            foreach (var vName in _aircraft)
            {
                //Debug.Log("EA6B BSCSCR Patch 1.19: " + vName);
            ...
            sw.Stop();
            //Debug.Log("EA6B [CSIPatch] Time converting custom campaigns ToIngameCampaigns: " + sw.ElapsedMilliseconds);
            sw.Reset();
            int num;
            //Debug.Log("EA6B BSCSCR Patch 1.22");
            for (var i = 0; i < _campaigns.Count; i = num + 1)
            {
                //Debug.Log("EA6B BSCSCR Patch 1.23");
            ...
            //Debug.Log("EA6B BSCSCR Patch 1.28");
            ...
            if (setupList == null)
            {
                //Debug.Log("EA6B BSCSCR Patch 1.28.1");
            }
    ...
    public static class EA6B_CSIPatch_FinallyOpenCampaignSelector
    {
        ...
        {
            //Debug.unityLogger.logEnabled = Main.logging;
            //Debug.Log("EA6B CSI Patch 1.1");
            var traverse = Traverse.Create(instance);
            instance.campaignDisplayObject.SetActive(true);
            instance.missionBriefingDisplayObject.SetActive(false);
            //Debug.Log("EA6B CSI Patch 1.2");
            yield return instance.StartCoroutine(CSIPatchUtils.BetterSetupCampaignScreenRoutine(instance));
            //Debug.Log("EA6B CSI Patch 1.2.1.1");
            if (onOpenedSelector != null)
            {
                //Debug.Log("EA6B CSI Patch 1.3");
                onOpenedSelector();
                yield break;
            }
            //Debug.Log("EA6B CSI Patch 1.2.1.2");
            try
            {
                //Debug.Log("EA6B CSI Patch 1.2.1.2.1");
                String1 = PilotSaveManager.currentCampaign.campaignName;
                //Debug.Log("EA6B CSI Patch 1.2.1.2.2");
            }
            
            catch (NullReferenceException)
            {
                //Debug.Log("EA6B CSI Patch 1.2.1.2.4");
            ...
            //Debug.Log("EA6B CSI Patch 1.2.1.3");
            if (String1 == null) { yield break; }
            //Debug.Log("EA6B CSI Patch 1.2.1" + PilotSaveManager.currentCampaign.campaignName);
            if (!PilotSaveManager.currentCampaign) yield break;
            //Debug.Log("EA6B CSI Patch 1.4");
            ...
            //Debug.Log("EA6B CSI Patch 1.5");
            if (num >= 0)
            {
                //Debug.Log("EA6B CSI Patch 1.6");
                ...
                if (num2 >= 0)
                {
                    //Debug.Log("EA6B CSI Patch 1.10" + num2);
                    //this.missionIdx = num2;
                    traverse.Field("missionIdx").SetValue(num2);
                    //Debug.Log("EA6B CSI Patch 1.10.1");
                    instance.MissionsButton();
                    //Debug.Log("EA6B CSI Patch 1.10.2");
                }
                else
                {
                    //Debug.Log("EA6B CSI Patch 1.11");
                    var numa = _campaigns[(int)_campaignIdx.GetValue()];
                    //Debug.Log("EA6B CSI Patch 1.11.0");
                    num2 = numa.trainingMissions
                        .FindIndex(x => PilotSaveManager.currentScenario.scenarioID == x.scenarioID);
                    //Debug.Log("EA6B CSI Patch 1.11.1" + num2) ;
                    if (num2 < 0) yield break;
                    //this.trainingIdx = num2;
                    //Debug.Log("EA6B CSI Patch 1.12");
            ...
            else if ((bool)traverse.Field("openedWorkshopCampaign").GetValue()) //CampaignSelectorUI.openedWorkshopCampaign
            {
                ...
                {
                    //Debug.Log("EA6B CSI Patch 1.14");
                    while (enumerator.MoveNext())
                    {
                        //Debug.Log("EA6B CSI Patch 1.15");
                        ...
                        //Debug.Log("EA6B CSI Patch 1.16");
                        var _viewingCampaign = (Campaign)traverse.Field("viewingCampaign").GetValue();
                        while (_viewingCampaign == null)
                        {
                            //Debug.Log("EA6B CSI Patch 1.17");
                            _viewingCampaign = (Campaign)traverse.Field("viewingCampaign").GetValue();
                            yield return null;
                        }
                        if (lastCSave == null)
        ...
        {
            //Debug.unityLogger.logEnabled = Main.logging;
            //Debug.Log("EA6B CSI Patch 1.20: cv = " + PilotSaveManager.currentVehicle.vehicleName + ", ModVN = " + AircraftInfo.vehicleName);

            if (PilotSaveManager.currentVehicle.vehicleName != AircraftInfo.vehicleName) { return; }
            //Debug.Log("EA6B CSI Patch 1.20");
            instance = __instance;
            //Debug.Log("EA6B CSI Patch 1.21");
            instance.StartCoroutine(CSI_FinallyOpenCampaignSelectorRoutine(onOpenedSelector));
            //Debug.Log("EA6B CSI Patch 1.22");
        }
    }

    [HarmonyPatch(typeof(CampaignSelectorUI), "StartWorkshopCampaign")]
    class EA6B_CSIPatch_StartWorkshopCampaign
    {
        static CampaignSelectorUI instance;
        ...
        static IEnumerator CSI_StartWorkshopCampaignRoutine(string campaignID)
        {
            ...
            //Debug.Log("EA6B CSI Patch 2.2");
            var campaign = VTResources.GetSteamWorkshopCampaign(campaignID);
            if (campaign == null)
            {
                //Debug.Log("EA6B CSI Patch 2.3");
                //Debug.Log("EA6B Missing campaign in CSI_StartWorkshopCampaignRoutine");
            }
            ...
            //Debug.Log("EA6B CSI Patch 2.8");
            instance.campaignDisplayObject.SetActive(true);
            PilotSaveManager.currentCampaign = campaign2;
            //Debug.Log("EA6B CSI Patch 2.9");
        ...
        {
            if (PilotSaveManager.currentVehicle.vehicleName == AircraftInfo.vehicleName) { return true; }
            //Debug.Log("EA6B CSI Patch 2.0.1");
            {
                //Debug.Log("EA6B CSI Patch 2.0.2");
                instance = __instance;
    ...
    class EA6B_CSIPatch_StartWorkshopMission
    {
        static CampaignSelectorUI instance;
        ...
        {
            //Debug.unityLogger.logEnabled = Main.logging;
            //Debug.Log("EA6B CSI Patch 3.0.1");
            var traverse = Traverse.Create(instance);
            ...
            //Debug.Log("EA6B CSI Patch 3.6");
            foreach (var mission in campaign.missions)
            {
                //Debug.Log("EA6B CSI Patch 3.6.1");
                ...
                //Debug.Log("EA6B CSI Patch 3.6.2");
