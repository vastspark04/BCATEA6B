...
using CustomAircraftTemplateEA6B.Patches.TranspilerStuff;
using Harmony;
using Harmony.Extensions.CustomAircraftTemplateEA6B;
using RewiredConsts;
using UnityEngine;

namespace CustomAircraftTemplateEA6B.Patches.CampaignStuff
{
    [HarmonyPatch]
